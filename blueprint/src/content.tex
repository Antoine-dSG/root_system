...
Finally, define $s: I_n \to \text{Perm}(I_n)$ as follows. 

Fix $J \in I_n^+$. If $K \in I_n^-$ then $s_J(K) = -s_J(-K)$. Thus, it suffices to define $s_J(K)$ for $K \in I_n^+$. 
Consider the following four mutually exclusive cases:
\begin{description} 
    \item 
    \item 
    \item 
